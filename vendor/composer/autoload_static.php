...
class ComposerStaticInitac3d464198b78f5d177f42bc72f77e2d
{
    ...
    public static $classMap = array (
        ...
        'NSS_Activator' => __DIR__ . '/../..' . '/includes/class-nss-activator.php',
        'NSS_Admin' => __DIR__ . '/../..' . '/includes/admin/class-nss-admin.php',
        'NSS_Calculator' => __DIR__ . '/../..' . '/includes/calculations/class-nss-calculator.php',
        'NSS_Database' => __DIR__ . '/../..' . '/includes/database/class-nss-database.php',
        'NSS_Deactivator' => __DIR__ . '/../..' . '/includes/class-nss-deactivator.php',
        'NSS_Fee' => __DIR__ . '/../..' . '/includes/models/class-nss-fee.php',
        'NSS_Formatting' => __DIR__ . '/../..' . '/includes/helpers/class-nss-formatting.php',
        'NSS_PDF_Generator' => __DIR__ . '/../..' . '/includes/pdf/class-nss-pdf-generator.php',
        'NSS_Plugin' => __DIR__ . '/../..' . '/includes/class-nss-plugin.php',
        'NSS_Precision_Math' => __DIR__ . '/../..' . '/includes/calculations/class-nss-precision-math.php',
        'NSS_Property_Value' => __DIR__ . '/../..' . '/includes/calculations/class-nss-property-value.php',
        'NSS_REST_API' => __DIR__ . '/../..' . '/includes/api/class-nss-rest-api.php',
        'NSS_Security' => __DIR__ . '/../..' . '/includes/helpers/class-nss-security.php',
        'NSS_Sheet' => __DIR__ . '/../..' . '/includes/models/class-nss-sheet.php',
        'NSS_Shortcodes' => __DIR__ . '/../..' . '/includes/frontend/class-nss-shortcodes.php',
        'NSS_Tax_Proration' => __DIR__ . '/../..' . '/includes/calculations/class-nss-tax-proration.php',
        'NSS_Updater' => __DIR__ . '/../..' . '/includes/class-nss-updater.php',
    ...
    public static function getInitializer(ClassLoader $loader)
    {
        return \Closure::bind(function () use ($loader) {
            $loader->prefixLengthsPsr4 = ComposerStaticInitac3d464198b78f5d177f42bc72f77e2d::$prefixLengthsPsr4;
            $loader->prefixDirsPsr4 = ComposerStaticInitac3d464198b78f5d177f42bc72f77e2d::$prefixDirsPsr4;
            $loader->classMap = ComposerStaticInitac3d464198b78f5d177f42bc72f77e2d::$classMap;

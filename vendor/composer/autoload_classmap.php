...
return array(
    ...
    'NSS_Activator' => $baseDir . '/includes/class-nss-activator.php',
    'NSS_Admin' => $baseDir . '/includes/admin/class-nss-admin.php',
    'NSS_Calculator' => $baseDir . '/includes/calculations/class-nss-calculator.php',
    'NSS_Database' => $baseDir . '/includes/database/class-nss-database.php',
    'NSS_Deactivator' => $baseDir . '/includes/class-nss-deactivator.php',
    'NSS_Fee' => $baseDir . '/includes/models/class-nss-fee.php',
    'NSS_Formatting' => $baseDir . '/includes/helpers/class-nss-formatting.php',
    'NSS_PDF_Generator' => $baseDir . '/includes/pdf/class-nss-pdf-generator.php',
    'NSS_Plugin' => $baseDir . '/includes/class-nss-plugin.php',
    'NSS_Precision_Math' => $baseDir . '/includes/calculations/class-nss-precision-math.php',
    'NSS_Property_Value' => $baseDir . '/includes/calculations/class-nss-property-value.php',
    'NSS_REST_API' => $baseDir . '/includes/api/class-nss-rest-api.php',
    'NSS_Security' => $baseDir . '/includes/helpers/class-nss-security.php',
    'NSS_Sheet' => $baseDir . '/includes/models/class-nss-sheet.php',
    'NSS_Shortcodes' => $baseDir . '/includes/frontend/class-nss-shortcodes.php',
    'NSS_Tax_Proration' => $baseDir . '/includes/calculations/class-nss-tax-proration.php',
    'NSS_Updater' => $baseDir . '/includes/class-nss-updater.php',
